			...
			<nav class="navbar navbar-default navbar-static-top"
				...
				<div class="navbar-header">
					...
					<ul class="nav navbar-nav navbar-right pull-right" id="userinfobar">
						...
						<li class="nav-item userlogout"><a href="#" class="nav-link"
							 style="font-size: 10px;">[退出登录]</a></li>
					</ul>
					<%
					...
					<ul class="nav navbar-nav navbar-right pull-right" id="userinfobar">
						...
						<li class="nav-item userlogout"><a href="#" class="nav-link" style="font-size: 10px;">[退出登录]</a></li>
					</ul>
					<%
						} else {
					%>
						...
						<ul class="nav">
							...
							<li><img src="<%=basePath%>img/safecenter.png" alt=""
								...
								<ul class="nav" id="side-menu">
									...
									<li><a href="<%=basePath%>bbs/MobileBindQuestion.action"class="active">
			...
			<div id="page-wrapper">
				...
				<div class="panel panel-default">
					<div class="panel-body">
						<div>
							<span><label style="font-size: 20px; font-weight: normal"><%if(curstates.getMobileidenstate()==1) {%>当前关联手机号:<%=curstates.getMobileiden() %><%}else{ %>未绑定手机号<%} %></label>&nbsp;&nbsp;<%if(curstates.getMobileidenstate()==1) {%><a
								href="<%=basePath %>bbs/MobileBind.action">修改手机号码</a><%}else{ %><a
								href="<%=basePath %>bbs/MobileBind.action">前去绑定</a><%} %></span>
							<h5 style="margin-bottom: 50px;"><%if(curstates.getMobileidenstate()==1) {%>手机主账号，可以用手机号码登录该账号<%}else{ %>建议您尽快关联手机号码<%} %></h5>
						</div>
						<div>
							<hr>
						</div>
									...
									<tr>
										<td>
											<div class="flip divhead">
												<span style="font-size: 14px; font-weight: bolder;">为什么要绑定手机？</span><i
													class="fa fa-caret-down"
													style="float: right; font-size: x-large;"></i>
											</div>
											<div class="contentpanel">
												根据全国人大常委会关于加强网络信息保护的决定，互联网网站必须保证用户的真实性。也是为了保护您在飞控社区的用户隐私安全，所以需要绑定手机。并且不能取消手机绑定功能，尽请谅解。
											</div>
										</td>
									</tr>
									<tr>
										<td>
											<div class="flip current">
												<span style="font-size: 14px; font-weight: bolder;">绑定的手机号码忘记了，要如何更改？</span><i
													class="fa fa-caret-down"
													style="float: right; font-size: x-large;"></i>
											</div>
											<div class="contentpanel">
												如果您认证过邮箱，可选择 <a href="#">认证邮箱修改</a>。如无认证邮箱请在邮箱认证页面进行绑定，认证满三个月后方可通过认证邮箱修改手机号。
											</div>
										</td>
									</tr>
									<tr>
										<td>
											<div class="flip divhead">
												<span style="font-size: 14px; font-weight: bolder;">一个手机能否绑定多个账号？</span><i
													class="fa fa-caret-down"
													style="float: right; font-size: x-large;"></i>
											</div>
											<div class="contentpanel">
												一个手机每个月只能注册一个，如果您这个月已经注册过一个账号了，那就要等30天后才能注册新的账号。</div>
										</td>
									</tr>
									<tr>
										<td>
											<div class="flip divhead">
												<span style="font-size: 14px; font-weight: bolder;">如何用手机号码登录飞控社区？</span><i
													class="fa fa-caret-down"
													style="float: right; font-size: x-large;"></i>
											</div>
											<div class="contentpanel">
												直接输入手机号与对应密码即可登录飞控社区，默认登录账号为您手机号码所绑定的主账号，可自由更换。</div>
										</td>
									</tr>
								</tbody>
							</table>
